...
def main():
    ...
    parser.add_argument('--model', type=str, default='HKGAT', help='Model name, choices=[Flashback, HKGAT, RNN, LSTM, GRU, STAN, GraphFlashback, Deepmove]')
    ...
    parser.add_argument('--gat_batch_size', type=int, default=32, help='GAT Batch size')
    ...
    parser.add_argument('--fb_hidden_size', type=int, default=128, help='Hidden dimension of flashback')
    ...
    parser.add_argument('--gfb_lr', type=float, default=0.0001, help='Learning rate of flashback')
    parser.add_argument('--gfb_kg_lr', type=float, default=0.0001, help='Learning rate of flashback kg')
    parser.add_argument('--gfb_kg_epochs', type=int, default=50, help='Number of epochs of flashback kg')
    parser.add_argument('--gfb_weight_decay', type=float, default=0.00001, help='Weight decay of flashback')
    parser.add_argument('--gfb_epochs', type=int, default=100, help='Number of epochs of flashback')
